...
console.log('✅ 表情関数（描画重複修正版）を読み込み完了');
// 🔧 追加：現在のモデル設定を保存
...
/**
 * ベースアイドルモーション（ふわふわ）のON/OFF切り替え（表情重複バグ修正版）
 */
